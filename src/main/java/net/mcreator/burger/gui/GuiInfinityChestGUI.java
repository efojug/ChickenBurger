...
import net.mcreator.burger.procedure.ProcedurePaste;
...
public class GuiInfinityChestGUI extends ElementsBurger.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiInfinityChestGUI(ElementsBurger instance) {
		super(instance, 20);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 49, 30) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 115, 30) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("burger:textures/infinitychestgui.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 62, this.guiTop + 58, 60, 20, "Paste!"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedurePaste.executeProcedure($_dependencies);
			}
		}
	}
