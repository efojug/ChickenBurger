...
package net.mcreator.burger.gui;
...
public class GuiWrappingPaperGUI extends ElementsBurger.ModElement {
	public static int GUIID = 6;
	public static HashMap guistate = new HashMap();
	public GuiWrappingPaperGUI(ElementsBurger instance) {
		super(instance, 68);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 35, 18) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 53, 18) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 71, 18) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 89, 18) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				Burger.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("burger:textures/wrappingpapergui.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 112, this.guiTop + 16, 50, 20, "W.I.P"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			Burger.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
