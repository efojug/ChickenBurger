...
import net.mcreator.burger.procedure.ProcedurePostcardRightClicked;
...
public class ItemPostcard extends ElementsBurger.ModElement {
	@GameRegistry.ObjectHolder("burger:postcard")
	public static final Item block = null;
	public ItemPostcard(ElementsBurger instance) {
		super(instance, 65);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("burger:postcard", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setTranslationKey(Burger.MODID + ".postcard");
			//setUnlocalizedName("postcard");
			setRegistryName("postcard");
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedurePostcardRightClicked.executeProcedure($_dependencies);
			}
			return ar;
		}
